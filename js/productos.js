let stockProductos = [
    ...
    {id: 5, nombre: "Reducción", tipo: "ACTIVIDAD", cantidad: 1, desc: "Reducción", valor: 0.7},
    ...
    {id: 8, nombre: "Continuación", tipo: "ACTIVIDAD", cantidad: 1, desc: "Continuación", valor: 0.45},
    {id: 9, nombre: "Central comun", tipo: "CENTRAL", cantidad: 1, desc: "Neo, Vista, 585, Caddx", valor: 1},
    {id: 10, nombre: "Central climax", tipo: "CENTRAL", cantidad: 1, desc: "Central climax", valor: 0.49},
    {id: 11, nombre: "Central RSI", tipo: "CENTRAL", cantidad: 1, desc: "Central rsi", valor: 0.6},
    {id: 12, nombre: "Placa wifi RSI", tipo: "CENTRAL", cantidad: 1, desc: "Wifi RSI", valor: 0.4},
    {id: 13, nombre: "Gab estanco", tipo: "CENTRAL", cantidad: 1, desc: "Estanco roker", valor: 1},
    {id: 14, nombre: "Expansora", tipo: "CENTRAL", cantidad: 1, desc: "Cualquier exp de zona o fuente", valor: 1},
    {id: 15, nombre: "Receptora", tipo: "RECEPTORA", cantidad: 1, desc: "Neo, vista, 585, encryptor", valor: 0.4},
    {id: 16, nombre: "Rele CF", tipo: "CF", cantidad: 1, desc: "Rele CF", valor: 0.5},
    {id: 17, nombre: "Caja Fuerte", tipo: "CF", cantidad: 1, desc: "Caja fuerte clasica/buzon", valor: 4},
    {id: 18, nombre: "Camara cab", tipo: "CAMARAS", cantidad: 1, desc: "Varifocal y bulet", valor: 1.5},
    {id: 19, nombre: "Camara ip", tipo: "CAMARAS", cantidad: 1, desc: "Cualquier manager", valor: 0.75},
    ...
    {id: 22, nombre: "Monitor", tipo: "CAMARAS", cantidad: 1, desc: "Monitor 19p", valor: 0.5},
    ...
    {id: 29, nombre: "Detector Bosch", tipo: "DETECTOR", cantidad: 1, desc: "DX, triple tec", valor: 1.5},
    ...
    {id: 32, nombre: "Detector AM", tipo: "DETECTOR", cantidad: 1, desc: "Antimasking", valor: 700},
    ...
    {id: 35, nombre: "Pulsador panico", tipo: "DETECTOR", cantidad: 1, desc: "PB1", valor: 1},
